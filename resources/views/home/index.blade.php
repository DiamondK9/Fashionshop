                    ...
                    <div class="brand-client-row">
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="client-carousel" style="width: 100px; display: block;">
                                    <!-- CLIENT-SINGLE START -->
                                    <div class="item">
                                        <div class="single-client">
                                            <a href="#">
                                                <img src="{{asset('asset_admin/images/11.png')}}" alt="brand-client" />
                                            </a>
                                        </div>                                  
                                    </div>
                                    <!-- CLIENT-SINGLE END -->
                                    ...
                                    <div class="item">
                                        <div class="single-client">
                                            <a href="#">
                                                <img src="{{asset('asset_admin/images/22.png')}}" alt="brand-client" />
                                            </a>
                                        </div>                                  
                                    </div>
                                    <!-- CLIENT-SINGLE END -->
                                    ...
                                    <div class="item">
                                        <div class="single-client">
                                            <a href="#">
                                                <img src="{{asset('asset_admin/images/33.png')}}" alt="brand-client" />
                                            </a>
                                        </div>                                  
                                    </div>
                                    <!-- CLIENT-SINGLE END -->
                                    ...
                                    <div class="item">
                                        <div class="single-client">
                                            <a href="#">
                                                <img src="{{asset('asset_admin/images/44.png')}}" alt="brand-client" />
                                            </a>
                                        </div>                                  
                                    </div>
                                    <!-- CLIENT-SINGLE END -->
                                    ...
                                    <div class="item">
                                        <div class="single-client">
                                            <a href="#">
                                                <img src="{{asset('asset_admin/images/55.png')}}" alt="brand-client" />
                                            </a>
                                        </div>                                  
                                    </div>
                                    <!-- CLIENT-SINGLE END -->
